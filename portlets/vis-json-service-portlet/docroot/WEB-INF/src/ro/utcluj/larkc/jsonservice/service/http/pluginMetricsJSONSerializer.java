 ...
 * @generated
 */
public class pluginMetricsJSONSerializer {
	public static JSONObject toJSONObject(pluginMetrics model) {
	...
	public static JSONArray toJSONArray(
		ro.utcluj.larkc.jsonservice.model.pluginMetrics[] models) {
	...
	public static JSONArray toJSONArray(
		List<ro.utcluj.larkc.jsonservice.model.pluginMetrics> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
